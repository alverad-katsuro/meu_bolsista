package alveradkatsuro.com.br.meu_bolsista.config.oauth2.handle;

import static alveradkatsuro.com.br.meu_bolsista.config.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private boolean isAuthorizedRedirectUri(String uri) {
        ...
        return List.of(oauthProperties.getAuthorizedRedirectUris())
                .stream()
