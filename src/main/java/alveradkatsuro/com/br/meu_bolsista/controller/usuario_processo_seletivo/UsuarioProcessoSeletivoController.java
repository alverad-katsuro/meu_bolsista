...
public class UsuarioProcessoSeletivoController {
	...
	// TODO fix isso mudar pra currentToken
	// @PostMapping(consumes = { MediaType.MULTIPART_FORM_DATA_VALUE })
	// @Operation(security = { @SecurityRequirement(name = "Bearer") })
	// public ResponseEntity<ResponseType> create(@CurrentUser UsuarioModel usuario,
	// @ModelAttribute UsuarioProcessoSeletivoCreateDTO
	// usuarioProcessoSeletivoCreateDTO)
	// throws IOException, DeadlineRegistrationException {
	// UsuarioProcessoSeletivoModel usuarioProcessoSeletivo =
	// usuarioProcessoSeletivoService
	...
	// return
	// ResponseEntity.created(WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(
	// this.getClass())
